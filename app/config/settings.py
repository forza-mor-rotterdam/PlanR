...
SESSION_EXPIRY_MAX_TIMESTAMP_COOKIE_NAME = "session_expiry_max_timestamp"
SESSION_EXPIRY_TIMESTAMP_COOKIE_NAME = "session_expiry_timestamp"
SESSION_EXPIRY_NOTIFICATION_PERIOD = int(
    os.getenv("SESSION_EXPIRY_NOTIFICATION_PERIOD", "900")
)
SESSION_EXPIRY_MAX_NOTIFICATION_PERIOD = int(
    os.getenv("SESSION_EXPIRY_MAX_NOTIFICATION_PERIOD", "60")
)
